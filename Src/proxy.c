...
accepting:
    ...
    if((proc_id = fork()) == 0)
    {
        ...
        printf("\t-> url_host is : %s\n", url_host);
        printf("\t-> url_path is: %s\n", url_path);
        printf("\t-> URL id: %s\n", url_encoded);
